...
<div class="ticket-container">
    <h5 id="event_name" <?php echo 'data-value="'.$event['event_name'].'"';?> style="margin-top: 4vh;">
        <?php echo $event['event_name']?></h5>
    <hr />
    ...
    <div class="event-location">
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15955.416329638387!2d36.777006!3d-1.2596849!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xf85d989cbb0ecc60!2sAbc%20Place%20Nairobi!5e0!3m2!1sen!2ske!4v1652695787992!5m2!1sen!2ske"
    ...
    <div class="payment">
        <div class="select-types">
            ...
            <p id="event-price" <?php echo 'data-value="'.$event['event_price'].'"';?>>Price:
                <?php echo $event['event_price'];?></p>
